...
function RootDocument({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ja" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-slate-100 text-slate-900 antialiased [overflow-wrap:anywhere] selection:bg-cyan-200 dark:bg-slate-950 dark:text-slate-100 dark:selection:bg-cyan-500/30">
        {children}
        <TanStackDevtools
          config={{
